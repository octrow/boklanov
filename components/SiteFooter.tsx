    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <nav className={styles.col} aria-label={tA11y('footerNav')}>
          ...
          <Link href='/awards' className={styles.footerLink}>
            {t('awards')}
          </Link>
          ...
          <Link href='/archive' className={styles.footerLink}>
            {t('archive')}
          </Link>
        </nav>
        ...
        <div className={styles.col}>
          <a
            href={`mailto:roman.boklanov@web.de`}
            className={styles.footerLink}
          >
            roman.boklanov@web.de
          </a>
          <a
            href={TELEGRAM_URL}
            target='_blank'
      ...
      <small className={styles.colophon}>{tFooter('colophon')}</small>
    </footer>
  )
}
