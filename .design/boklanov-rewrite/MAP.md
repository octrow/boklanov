...
| 7 | `.design/boklanov-rewrite/FEATURED_STRIP_GRID_RESEARCH.md` | Broken-grid root-cause analysis + 3 ranked implementation options for `<FeaturedStrip>` re-implementation (§2.4 rollback resolution) | ~130 |
