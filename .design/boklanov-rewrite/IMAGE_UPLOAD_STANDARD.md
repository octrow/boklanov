...
- **The one improvement worth making**: bake the four AVIFs inline inside `/api/r2-asset` so admin uploads don't depend on a human remembering `npm run bake-variants` afterwards.
