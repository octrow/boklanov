...
> | 6.6 — Post-R1 QA findings (Q1–Q7) | ✅ done | All seven shipped between commits `10f951f` (Q1+Q2 sync filter + RU↔EN merge), `b3bded7` (Q3 synopsis), `fdbae94` (Q4 awards + overlay path), `99299de` (Q5 about chronology), `8dae0b2` (Q6 poster fallback), `c7647bf` (Q7 contact reorder). 24 productions clean (down from 28 with 4 bogus dropped), zero language pollution in awards, brutalist no-poster fallback, TG+IG primary on `/contact`. Two follow-ups noted in TASKS.md: (a) two festival-in-plain-prose awards (cinderella, sugar-kid) need hand-overlay; (b) Roman to confirm RGISI / first-BTK milestone years before R2. |
