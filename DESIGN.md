...
- Bento grids on home — _v3 §2.4 unfreeze ROLLED BACK 2026-05-03 (fix-pass-2): both asymmetric broken-grid attempts collided with the 4:5 ProductionCard aspect-ratio (variable column widths produced variable poster heights → misaligned baselines, floating hairlines, dead space). `<FeaturedStrip>` is now a clean 3-col equal-cell grid; bento ban restored. Plakat variety lives in DuotonePoster + Sticker, not card geometry. See DESIGN_v3_PROPOSAL.md §2.4 rollback trigger._
